...
const ItemCard = ({ currentItems, hasDescription, verticalDirection, index, Fade }) => {
  return (
    <>
      {currentItems &&
                ...
                >
                  ...
                  <div
                    className={`flex items-center gap-6 ${
                      verticalDirection ? 'pt-12' : 'pt-6'
                    } pb-12 ${verticalDirection ? 'border-t-2 border-borderColorWhite' : ''}`}
                  >
